...
# Loading in ICR data
setwd("~/Documents/Other 48hr Sampling Campaigns/Josh_Sharp/Josh_Sharp_Final/")
...
trans.full =  read.csv("~/Documents/Code Information (ESOM and 16S)/FTICR Scripts/Transformation_Database_07-2020.csv")
