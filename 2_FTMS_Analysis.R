...
#devtools::install_github("EMSL-Computing/ftmsRanalysis", force = TRUE)
...
Sample_Name = "ECA_ALL" # Sample name for output
...
#Change here
#This must be the output directory from 2_remove_poorly_calibrated
#setwd ("//pnl/Projects/ECA_Project/VGC/Report_water_3-5")
#Don't change
...
#Change here
 # setwd ("//pnl/Projects/ECA_Project/VGC/Output_formularity_INC/FTMS_Output")
write.csv(peak_icr$e_data, paste("Processed_", Sample_Name, "_Data.csv", sep = ""), quote = F, row.names = F)
write.csv(peak_icr$e_meta, paste("Processed_", Sample_Name, "_Mol.csv", sep = ""), quote = F, row.names = F)
